...
use App\Application\Http\Middleware\ApiVersionDeprecate;
use App\Application\Http\Middleware\Authenticate;
use App\Application\Http\Middleware\EncryptCookies;
use App\Application\Http\Middleware\PermissionMiddleware;
...
use App\Application\Http\Middleware\SetLocaleMiddleware;
