...
use App\Domain\Users\Http\Resources\Permission\RoleResourceByParameterNames;
...
class RetrieveCollectionRole extends Controller
{
    /**
        ...
        responses: [
            new Response(
                ...
                content: new JsonContent(
                    type: 'array',
                    items: new Items(
                        ref: '#/components/schemas/RoleResourceByParameterNames',
                    ),
                ),
            ),
            new Response(
    ...
    public function __invoke(DefaultSearchRequest $request): ResourceCollection
    {
        ...
        $roles = $this->searchService->search(Role::query(), $request);

        return RoleResourceByParameterNames::collection($roles);
    }
}
