...
class RetrieveCollectionTvtcOperators extends Controller
{
    /**
    ...
    #[Get(
        path: '/api/v1/users/tvtc-operators',
        summary: 'Get list of tvtc operators',
        security: [['sanctum' => []]],
        tags: [
            'Users',
        ],
    ...
    {
        $profiles = $this->searchService->search(EloquentProfileRepository::tvtcProfiles(), $request);
